// domain/usecase/stats/GetTopAlbumsUseCase.kt
...
/**
 * Retourne le Top 300 albums pour une période donnée.
 *
 * Note : écoutes album = somme des écoutes de tous ses titres.
 */
class GetTopAlbumsUseCase @Inject constructor(
    ...
    suspend operator fun invoke(
        ...
        return try {
            ...
            Result.Error("Erreur chargement top albums : ${e.message}", e)
        }
    }
}